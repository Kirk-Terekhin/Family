    ...
    {    
        ...
        */
        private function _getWeatherData() {
            ...
            //$query = 'select * from weather.forecast where w='.$this->woeid.'&u='.$this->params->get('tempUnit').'"';
            $query = 'select * from weather.forecast where woeid='.$this->woeid.' and u=\'' . $this->params->get('tempUnit') . '\'';

            $URL = $this->makeYQL($query, array('format'=>'json'));
        ...
        */
        private function _getForecastData(){
            ...
            $forecast_data = $this->data['query']['results']['channel']['item']['forecast'];
