...
.red {
	...
	<div id="installer-right">
		...
		<?php if ($messages['modules']) { ?>
			...
			<?php } ?>
		<?php } ?>
		<h2>Changelog v1.50.0</h2>
		<ul class="version-history">
			<li><span class="version-new">New</span> Relative paths are now accepted as Destinations in the &quot;File Upload&quot; field.</li>
			<li><span class="version-upgraded">Upg</span> Completely rewritten backup and restore functions.</li>
			<li><span class="version-upgraded">Upg</span> Backup name can be customized.</li>
			<li><span class="version-upgraded">Upg</span> New backup archives now allow you to keep the same form IDs when restoring.</li>
			<li><span class="version-upgraded">Upg</span> Plugins can now inject their own data into the backup, restore it, as well as delete it when you delete a form.<br /><strong class="red">Please update your RSForm! Pro plugins as well.</strong></li>
			<li><span class="version-upgraded">Upg</span> Syntax Highlighting script (CodeMirror) updated to 4.6.1</strong></li>
			<li><span class="version-fixed">Fix</span> List of available placeholders wasn't working on first click.</li>
			<li><span class="version-fixed">Fix</span> Not all form data was being deleted when you removed a form.</li>
		</ul>
